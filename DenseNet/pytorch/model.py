...
def densenet_121(num_classes:int) -> nn.Module:
    return DenseNet([6, 12, 24, 16], num_classes)

def densenet_169(num_classes:int) -> nn.Module:
    return DenseNet([6, 12, 32, 32], num_classes)

def densenet_201(num_classes:int) -> nn.Module:
    return DenseNet([6, 12, 48, 32], num_classes)

def densenet_264(num_classes:int) -> nn.Module:
